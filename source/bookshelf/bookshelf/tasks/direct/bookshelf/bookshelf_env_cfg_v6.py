...
"""Config for Bookshelf-Direct-v6.

V6 keeps v5's task, observations, randomization, rewards, and success checks,
but composes actions as nominal geometric motion plus learned PPO residual.
"""
...
class BookshelfEnvCfg(BookshelfEnvCfgV5):
    """Bookshelf v6: v5 with nominal geometric insertion plus learned residuals."""
    ...
    debug_hold_book_fixed_to_tool = True
    debug_use_full_target_ee_quat = True
    debug_position_only_target_ee = True
    ...
    debug_done_on_preinsert_reached = True
